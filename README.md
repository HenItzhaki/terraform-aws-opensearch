...
| [aws_opensearch_authorize_vpc_endpoint_access.this](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/opensearch_authorize_vpc_endpoint_access) | resource |
...
| <a name="input_authorize_vpc_endpoint_access_create"></a> [authorize\_vpc\_endpoint\_access\_create](#input\_authorize\_vpc\_endpoint\_access\_create) | Flag to indicate if VPC endpoint access authorization should be created | `bool` | `false` | no |
...
| <a name="input_aws_acccont_ids"></a> [aws\_acccont\_ids](#input\_aws\_acccont\_ids) | List of AWS account IDs to authorize for VPC endpoint access | `list(string)` | `[]` | no |
